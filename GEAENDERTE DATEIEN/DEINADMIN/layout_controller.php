 ...
 * @version $Id: layout_controller.php for Winchester 2024-11-16 19:39:11Z webchills $
 */
  ...
  switch ($_GET['action']) {
    case 'save':
      ...
      $updateValues = [
          ...
          'show_box_min_width' => (int)$_POST['show_box_min_width'],
      ];
    ...
    case 'reset_defaults':
        ...
        foreach ($reset_boxes as $reset_box) {
            ...
            $updateValues = [
                ...
                'show_box_min_width' => $reset_box['show_box_min_width'],
            ];
          ...
          <table class="table table-hover">
            <thead>
              <tr class="dataTableHeadingRow">
                ...
                <?php } ?>
                 <th class="dataTableHeadingContent text-center"><?php echo 'Show Box @ Min-Width'; ?></th>
            ...
            <tbody>
              ...
              <td class="<?php echo ($boxDirectory != '') ? 'dataTableContent' : 'messageStackError'; ?> text-center"><?php echo ($layoutBox['layout_box_status_single'] == '1' ? TEXT_ON : '<span class="alert">' . TEXT_OFF . '</span>'); ?></td>
                  <?php } ?>
              <td class="<?php echo ($boxDirectory != '') ? 'dataTableContent' : 'messageStackError'; ?> text-center"><?php echo $layoutBox['show_box_min_width']; ?></td>
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 configurationColumnRight">
            ...
            switch ($_GET['action']) {
              case 'edit':
                ...
                $contents[] = ['text' => '<b>Show this Box @ Min-Width</b><div class="radio"><label>' . zen_draw_radio_field('show_box_min_width', '1', $in_status_minwidth) . TEXT_ON . '</label></div><div class="radio"><label>' . zen_draw_radio_field('show_box_min_width', '0', $out_status_minwidth) . TEXT_OFF . '</label></div>'];
              ...
              default:
                if (is_object($bInfo)) {
                  ...
                  $contents[] = ['text' => 'Show this Box @ Min-Width' . ' ' . $bInfo->show_box_min_width];

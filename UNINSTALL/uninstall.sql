...
DELETE FROM configuration WHERE configuration_key = 'WIN_HEADER_MEGAMENU_STATUS';
...
DELETE FROM configuration_language WHERE configuration_key = 'WIN_TOTOP_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_SLIDEOUTBOX_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_TOPNOTICE_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_HEADER_CURRENCY_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_HEADER_LANGUAGE_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_FOOTER_PAYMENT_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_FOOTER_NAVI_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_FOOTER_SOCIALMEDIA_STATUS';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_GPSR_DATA_PRODUCT_INFO_TAB';
DELETE FROM configuration_language WHERE configuration_key = 'WIN_HEADER_MEGAMENU_STATUS';

...
* @version $Id: german.php for Winchester 2024-11-19 15:19:32Z webchills $
*/
// -----
...
define('BOX_HEADING_CATEGORIES','Sortiment');
...
define('FEMALE','Frau');
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a> | Shopsystem: <a href="https://www.zen-cart-pro.at" rel="noopener noreferrer" target="_blank">Zen Cart</a>');
...
define('TEXT_CLICK_TO_ENLARGE','<i class="fa-solid fa-magnifying-glass-plus"></i>');

 ...
 * @version $Id: tpl_account_default.php for Winchester 2024-11-22 15:10:16Z webchills $
 */
?>
...
<li><i class="fa-solid fa-pen-to-square"></i> <?php echo ' <a href="' . zen_href_link(FILENAME_ACCOUNT_EDIT, '', 'SSL') . '">' . MY_ACCOUNT_INFORMATION . '</a>'; ?></li>
<li><i class="fa-solid fa-pen-to-square"></i> <?php echo ' <a href="' . zen_href_link(FILENAME_ADDRESS_BOOK, '', 'SSL') . '">' . MY_ACCOUNT_ADDRESS_BOOK . '</a>'; ?></li>
<li><i class="fa-solid fa-pen-to-square"></i> <?php echo ' <a href="' . zen_href_link(FILENAME_ACCOUNT_PASSWORD, '', 'SSL') . '">' . MY_ACCOUNT_PASSWORD . '</a>'; ?></li>
</ul>
...
?>
<li><i class="fa-solid fa-pen-to-square"></i><?php echo ' <a href="' . zen_href_link(FILENAME_ACCOUNT_NEWSLETTERS, '', 'SSL') . '">' . EMAIL_NOTIFICATIONS_NEWSLETTERS . '</a>'; ?></li>
